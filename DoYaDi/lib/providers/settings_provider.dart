...
class SettingsProvider with ChangeNotifier {
  ...
  Future<void> loadSettings() async {
    ...
    _settings.backgroundColor =
        Color(prefs.getInt('backgroundColor') ?? const Color(0xFF050510).toARGB32());
    _settings.detailColor =
        Color(prefs.getInt('detailColor') ?? const Color(0xFF40E0D0).toARGB32());
    _settings.steeringIndicatorColor =
        Color(prefs.getInt('steeringIndicatorColor') ?? const Color(0xFF40E0D0).toARGB32());
    _settings.steeringBgColor =
        Color(prefs.getInt('steeringBgColor') ?? const Color(0xFF0A0A20).toARGB32());
    _settings.gasColor =
        Color(prefs.getInt('gasColor') ?? const Color(0xFF00C853).toARGB32());
    _settings.brakeColor =
        Color(prefs.getInt('brakeColor') ?? const Color(0xFFD50000).toARGB32());
    _settings.yetsoreColor =
        Color(prefs.getInt('yetsoreColor') ?? const Color(0xFFFFD600).toARGB32());
    _settings.pedalBgColor =
        Color(prefs.getInt('pedalBgColor') ?? const Color(0xFF050525).toARGB32());
  ...
  Future<void> saveSettings() async {
    ...
    await prefs.setInt('steeringIndicatorColor', _settings.steeringIndicatorColor.toARGB32());
